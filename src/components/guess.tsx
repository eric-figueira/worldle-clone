  ...
  return (
    <li>
      <div className="grid grid-cols-10 gap-1 items-center">
        <div className="col-span-4 py-1 bg-slate-100 border-2 border-slate-200 rounded-md text-center text-sm">
          {guess.country.name}
        </div>
        <div className="col-span-3 py-1 bg-slate-100 border-2 border-slate-200 rounded-md text-center text-sm">
